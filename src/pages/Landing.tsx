...
//             <div className="w-10 z-40 h-10 bg-gradient-primary rounded-xl flex items-center justify-center">
//               <Brain className="w-6 h-6 text-white" />
//                 {/* <Brain className="w-6 h-6 " /> */}
//             </div>
//             <div>
//               <h1 className="text-xl font-bold text-blue-900">TIME<span className="text-blue-600">grid</span></h1>
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold">TimeGRID</h1>
