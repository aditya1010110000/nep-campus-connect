                ...
                >
                  ...
                  <DialogContent className="sm:max-w-lg">
                    <DialogHeader>
                      <DialogTitle>
                        {requestType === "faculty"
                          ? "Faculty Unavailability Request"
                          : "Student Accommodation Request"}
                      </DialogTitle>
                      <DialogDescription>
                        {requestType === "faculty"
                          ? "Submit a request for periods when you will be unavailable to teach."
                          : "Request schedule accommodations for your academic needs."}
                      </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          placeholder={
                            requestType === "faculty"
                              ? "e.g., Medical Leave Request"
                              : "e.g., Schedule Change for Internship"
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          placeholder={
                            requestType === "faculty"
                              ? "Explain the reason for your unavailability and any specific requirements..."
                              : "Describe the accommodation needed and the reason for the request..."
                          }
                          rows={3}
                        />
                      </div>
...
// {requestType === 'student' && (
//                         <div>
//                           <Label htmlFor="room-type">Room Requirements</Label>
//                           <Select value={requestForm.reason} onValueChange={(value) => setRequestForm({...requestForm, reason: value})}>
//                             <SelectTrigger>
//                               <SelectValue placeholder="Select room type/requirements" />
//                             </SelectTrigger>
//                             <SelectContent>
//                               <SelectItem value="event_hall">Event Hall/Auditorium</SelectItem>
//                               <SelectItem value="study_room">Study Room</SelectItem>
//                               <SelectItem value="wifi_room">Room with Strong WiFi</SelectItem>
//                               <SelectItem value="empty_classroom">Empty Classroom</SelectItem>
//                               <SelectItem value="lab_room">Laboratory/Computer Lab</SelectItem>
...
//   const [requestType, setRequestType] = useState<'faculty' | 'student'>('faculty');
//   const [isRequestDialogOpen, setIsRequestDialogOpen] = useState(false);
...
//       id: 'REQ002',
//       type: 'accommodation',
//       title: 'Room Booking for Tech Fest Event',
//       requestedBy: 'Rahul Kumar',
//       userType: 'student',
//       date: '2024-01-14',
//       status: 'approved',
//       priority: 'medium',
//       description: 'Need auditorium with projector and sound system for tech presentation',
...
//       id: 'REQ004',
//       type: 'accommodation',
//       title: 'Room Request with High-Speed WiFi',
//       requestedBy: 'Priya Sharma',
//       userType: 'student',
//       date: '2024-01-12',
//       status: 'approved',
//       priority: 'high',
//       description: 'Need room with strong WiFi for online coding competition',
//       startDate: '2024-01-20',
//       endDate: '2024-01-20'
//     }
//   ]);
...
//   const quickReports = [
//     { name: 'Faculty Workload Report', icon: Users, downloads: 45, lastGenerated: '2 hours ago' },
//     { name: 'Room Utilization Analysis', icon: Building, downloads: 32, lastGenerated: '1 day ago' },
//     { name: 'Course Distribution Report', icon: BookOpen, downloads: 28, lastGenerated: '3 hours ago' },
//     { name: 'Semester Performance', icon: TrendingUp, downloads: 19, lastGenerated: '5 hours ago' }
//   ];
...
//       type: requestType === 'faculty' ? 'unavailability' : 'accommodation',
//       title: requestForm.title,
//       requestedBy: requestType === 'faculty' ? 'Current Faculty' : 'Current Student',
//       userType: requestType,
//       date: new Date().toISOString().split('T')[0],
//       status: 'pending',
//       priority: requestForm.priority,
...
//     toast({
//       title: "Request Submitted",
//       description: `Your ${requestType === 'faculty' ? 'unavailability' : 'room booking'} request has been submitted successfully.`,
//     });
//   };
...
//       {/* Header */}
//       <div className="text-center">
//         <h1 className="text-4xl font-bold text-gray-900 mb-2">Request & Analytics Center</h1>
//         <p className="text-lg text-gray-600">
//           Submit requests and access comprehensive analytics for your institution
//         </p>
//       </div>
...
//                     <Button className="bg-blue-600 hover:bg-blue-700">
//                       <Send className="w-4 h-4 mr-2" />
//                       Submit {requestType === 'faculty' ? 'Unavailability' : 'Room'} Request
//                     </Button>
//                   </DialogTrigger>
//                   <DialogContent className="sm:max-w-lg">
//                     <DialogHeader>
//                       <DialogTitle>
//                         {requestType === 'faculty' ? 'Faculty Unavailability Request' : 'Student Room Request'}
//                       </DialogTitle>
//                       <DialogDescription>
//                         {requestType === 'faculty' 
//                           ? 'Submit a request for periods when you will be unavailable to teach.'
//                           : 'Request room booking for events, study sessions, or rooms with specific amenities.'
//                         }
//                       </DialogDescription>
//                     </DialogHeader>
//                     <div className="space-y-4">
...
//                           placeholder={requestType === 'faculty' ? 'e.g., Medical Leave Request' : 'e.g., Room Booking for Cultural Event'}
//                         />
//                       </div>

//                       <div className="grid grid-cols-2 gap-4">
//                         <div>
//                           <Label htmlFor="start-date">{requestType === 'faculty' ? 'Start Date' : 'Event Date'}</Label>
//                           <Input
//                             id="start-date"
//                             type="date"
//                             value={requestForm.startDate}
...
//                         </div>
//                         <div>
//                           <Label htmlFor="end-date">{requestType === 'faculty' ? 'End Date' : 'End Date (if multi-day)'}</Label>
//                           <Input
//                             id="end-date"
//                             type="date"
//                             value={requestForm.endDate}
...
//                       <div>
//                         <Label htmlFor="priority">Priority</Label>
//                         <Select value={requestForm.priority} onValueChange={(value: 'low' | 'medium' | 'high') => setRequestForm({...requestForm, priority: value})}>
//                           <SelectTrigger>
//                             <SelectValue />
//                           </SelectTrigger>
//                           <SelectContent>
...
//                           placeholder={requestType === 'faculty' 
//                             ? 'Explain the reason for your unavailability and any specific requirements...'
//                             : 'Describe the purpose of room booking, expected attendees, and any special equipment needed (projector, sound system, etc.)...'
//                           }
//                           rows={3}
//                         />
//                       </div>
...
//                     Student Room Requests ({filteredRequests.length})
//                   </>
//                 )}
//               </CardTitle>
//               <CardDescription>
//                 {requestType === 'faculty'
//                   ? "View and manage faculty unavailability requests"
//                   : "View and manage student room booking requests"
//                 }
//               </CardDescription>
//             </CardHeader>
//             <CardContent>
...
//               </CardHeader>
//               <CardContent>
//                 <div className="text-2xl font-bold text-blue-600">{analyticsData.generatedReports}</div>
//                 <p className="text-xs text-muted-foreground">
//                   Total reports created
//                 </p>
//               </CardContent>
...
//               </CardHeader>
//               <CardContent>
//                 <div className="text-2xl font-bold text-green-600">{analyticsData.dataPoints.toLocaleString()}</div>
//                 <p className="text-xs text-muted-foreground">
//                   Analyzed data entries
//                 </p>
//               </CardContent>
...
//               </CardHeader>
//               <CardContent>
//                 <div className="text-2xl font-bold text-purple-600">{analyticsData.efficiency}%</div>
//                 <p className="text-xs text-muted-foreground">
//                   Overall performance
//                 </p>
//               </CardContent>
...
//               </CardHeader>
//               <CardContent>
//                 <div className="text-2xl font-bold text-orange-600">{analyticsData.activeReports}</div>
//                 <p className="text-xs text-muted-foreground">
//                   Currently processing
//                 </p>
//               </CardContent>
...
//               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                 {quickReports.map((report) => (
//                   <Card key={report.name} className="border border-gray-200 hover:border-blue-300 transition-colors">
//                     <CardContent className="p-4">
//                       <div className="flex items-center justify-between mb-3">
//                         <div className="flex items-center gap-3">
//                           <report.icon className="w-5 h-5 text-blue-600" />
...
//                   <p className="text-gray-600 mb-6">
//                     Select your data sources, metrics, and filters to create personalized analytics reports
//                   </p>
//                 </div>
...
//                             <SelectItem value="comparison">Comparative Study</SelectItem>
...
//                       <div>
//                         <Label htmlFor="department">Department</Label>
//                         <Select value={customReportForm.department} onValueChange={(value) => setCustomReportForm({...customReportForm, department: value})}>
//                           <SelectTrigger>
//                             <SelectValue placeholder="Select department" />
//                           </SelectTrigger>
//                           <SelectContent>
...
//                       <div>
//                         <Label htmlFor="date-range">Date Range</Label>
//                         <Select value={customReportForm.dateRange} onValueChange={(value) => setCustomReportForm({...customReportForm, dateRange: value})}>
//                           <SelectTrigger>
//                             <SelectValue />
//                           </SelectTrigger>
//                           <SelectContent>
//                             <SelectItem value="current_semester">Current Semester</SelectItem>
//                             <SelectItem value="previous_semester">Previous Semester</SelectItem>
...
//               </CardTitle>
//               <CardDescription className="text-blue-700">
//                 Unlock powerful insights with our next-generation analytics platform featuring AI-powered predictions and real-time monitoring
//               </CardDescription>
//             </CardHeader>
//             <CardContent>
//               <div className="space-y-4">
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                   <div className="space-y-2">
//                     <h4 className="font-semibold text-blue-900">🎯 Advanced Features</h4>
//                     <ul className="text-sm text-blue-800 space-y-1">
//                       <li>• Predictive analytics & forecasting</li>
//                       <li>• Real-time dashboard monitoring</li>
//                       <li>• Interactive data visualizations</li>
...
//                   </div>
//                   <div className="space-y-2">
//                     <h4 className="font-semibold text-blue-900">📊 Smart Analytics</h4>
//                     <ul className="text-sm text-blue-800 space-y-1">
//                       <li>• Machine learning-powered insights</li>
//                       <li>• Anomaly detection & alerts</li>
//                       <li>• Cross-departmental comparisons</li>
...
//                     <DialogContent>
//                       <DialogHeader>
//                         <DialogTitle>Request Advanced Analytics Access</DialogTitle>
//                         <DialogDescription>
//                           Be among the first to experience our advanced analytics dashboard. 
